...
const WhereWeOperate = () => {
  ...
  return <section className="py-20 bg-neutral-900">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
          {states.map((state, index) => <div key={index} className="group flex flex-col items-center justify-center border-2 border-accent bg-white text-accent rounded-xl px-8 py-8 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer">
